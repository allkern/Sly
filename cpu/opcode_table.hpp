...
namespace snes {
    namespace cpu {
        ...
        opcode_t map[] = {
            ...
            /*4*/{ rti, imp, 6 }, { eor, dix, 6 }, { wdm, imp, 0 }, { eor, str, 4 }, { mvp, bmm, 1 }, { eor, dpg, 3 }, { lsr, dpg, 5 }, { eor, dil, 6 }, { pha, imp, 3 }, { eor, ima, 2 }, { sra, imp, 2 }, { phk, imp, 3 }, { jmp, abj, 3 }, { eor, abd, 4 }, { lsr, abd, 6 }, { eor, lng, 5 },
